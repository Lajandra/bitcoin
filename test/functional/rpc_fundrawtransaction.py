...
||||||| parent of 98cd6a43950 (RPC: Allow RPC methods accepting options to take named parameters)
            assert_raises_rpc_error(-3, "Expected type string for estimate_mode, got {}".format(k),
                node.fundrawtransaction, rawtx, {"estimate_mode": v, "conf_target": 0.1, "add_inputs": True})
=======
            assert_raises_rpc_error(-3, "Expected type string for estimate_mode, got {}".format(k),
                node.fundrawtransaction, rawtx, estimate_mode=v, conf_target=0.1, add_inputs=True)
>>>>>>> 98cd6a43950 (RPC: Allow RPC methods accepting options to take named parameters)
...
>>>>>>> 98cd6a43950 (RPC: Allow RPC methods accepting options to take named parameters)
    ...
    def test_add_inputs_default_value(self):
        ...
        assert_raises_rpc_error(-4, "Insufficient funds", wallet.send, outputs=[{addr1: 8}], **options)
        ...
        assert_raises_rpc_error(-4, "Insufficient funds", wallet.send, outputs=[{addr1: 3}], **options)
        ...
        options = {"add_inputs": False}
        assert_raises_rpc_error(-4, "Insufficient funds", wallet.walletcreatefundedpsbt, inputs=[], outputs=outputs, **options)
