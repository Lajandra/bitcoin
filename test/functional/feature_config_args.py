...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        self.nodes[0].assert_start_raises_init_error(extra_args=[f"-conf={main_conf_file_path}", "-warnignoredconf"], expected_msg='Error: acceptnonstdtxn is not currently supported for main chain')
    ...
    def test_ignored_conf(self):
        ...
        with tempfile.NamedTemporaryFile(dir=self.options.tmpdir, mode="wt") as temp_conf:
            node = self.nodes[0]
