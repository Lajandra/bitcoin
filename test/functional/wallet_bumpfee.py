...
||||||| parent of d936e991a63 (test: Update python tests to use named parameters instead of options objects)
        bumped_psbt = rbf_node.psbtbumpfee(rbfid, {"fee_rate": str(NORMAL)})
        bumped_tx = rbf_node.bumpfee(rbfid, {"fee_rate": NORMAL})
=======
        bumped_psbt = rbf_node.psbtbumpfee(rbfid, fee_rate=str(NORMAL))
        bumped_tx = rbf_node.bumpfee(rbfid, fee_rate=NORMAL)
>>>>>>> d936e991a63 (test: Update python tests to use named parameters instead of options objects)
    else:
