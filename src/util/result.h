...
protected:
    ...
    //! Error case initializer without no message.
    template<typename...Args>
    void Construct(Error, Args&&... args)
    {
        InitFailure(std::forward<Args>(args)...);
    }

    //! Error case initializer with message.
    template<typename...Args>
    void Construct(Error, bilingual_str error, Args&&... args)
    {
    ...
    template<typename...Args>
    void Construct(Warning, bilingual_str warning, Args&&... args)
    {
    ...
    //! Chained initializer.
    template<typename PrevT, typename PrevE, typename... Args>
    void Construct(Chain, Result<PrevT, PrevE>&& prev, Args&&... args)
    {
