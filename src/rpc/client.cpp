...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "walletcreatefundedpsbt", -1, "add_inputs"},
    { "walletcreatefundedpsbt", -1, "include_unsafe"},
    { "walletcreatefundedpsbt", -1, "minconf"},
    { "walletcreatefundedpsbt", -1, "maxconf"},
    ...
    { "walletcreatefundedpsbt", -1, "solving_data"},
