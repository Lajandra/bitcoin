...
||||||| parent of 6d131ab998e (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
        const int64_t load_block_index_start_time = GetTimeMillis();
        auto catch_exceptions = [](auto&& f) {
=======
        const int64_t load_block_index_start_time = GetTimeMillis();
        auto catch_exceptions = [](auto&& f) -> util::Result<void, node::ChainstateLoadError> {
>>>>>>> 6d131ab998e (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
            try {
                return f();
