...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-warnignoredconf", strprintf("For backwards compatibility, suppress error \"%s would be ignored\" and log it as a warning, not an error.", BITCOIN_CONF_FILENAME), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
