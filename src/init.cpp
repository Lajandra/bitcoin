...
||||||| parent of 53019c6fb944 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
...
=======
        if (!result && (result.GetFailure() == node::ChainstateLoadError::FAILURE_INCOMPATIBLE_DB ||
            ...
            return InitError(util::ErrorString(result));
>>>>>>> 53019c6fb944 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
        }
