...
||||||| parent of 48e31685a03d (Fix nonsensical -norpcwhitelist, -norpcallowip and related behavior)
    if (args.IsArgSet("-connect")) {
=======
    if (args.GetArgs("-connect").size() > 0) {
>>>>>>> 48e31685a03d (Fix nonsensical -norpcwhitelist, -norpcallowip and related behavior)
