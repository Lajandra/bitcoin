...
||||||| parent of 2b9234a0292 (refactor: Make CWallet:::AttachChain return scan status)
    LOCK(walletInstance->cs_wallet);
...
||||||| parent of ce81e22f4ff (Wallet passive startup)
    LOCK(walletInstance->cs_wallet);

=======
>>>>>>> ce81e22f4ff (Wallet passive startup)
...
>>>>>>> 2b9234a0292 (refactor: Make CWallet:::AttachChain return scan status)
        return nullptr;
    }
