...
||||||| parent of 33af67edbd9 (refactor: Detach wallet transaction methods (followup for move-only))
=======
#include <wallet/receive.h>
#include <wallet/spend.h>
>>>>>>> 33af67edbd9 (refactor: Detach wallet transaction methods (followup for move-only))
