...
||||||| parent of 7eef25e5ee4 (indexes, refactor: Remove remaining CBlockIndex* pointers from indexing code)
    bool LookupFilterHeader(const CBlockIndex* block_index, uint256& header_out);
=======
    bool LookupFilterHeader(const interfaces::BlockKey& block, uint256& header_out);
>>>>>>> 7eef25e5ee4 (indexes, refactor: Remove remaining CBlockIndex* pointers from indexing code)
