...
||||||| parent of a0b803d1977 (indexes, refactor: Remove remaining CBlockIndex* uses in index Rewind methods)
// Reverse a single block as part of a reorg
bool CoinStatsIndex::ReverseBlock(const CBlock& block, const CBlockIndex* pindex)
=======
...
>>>>>>> a0b803d1977 (indexes, refactor: Remove remaining CBlockIndex* uses in index Rewind methods)
{
    std::pair<uint256, DBVal> read_out;
