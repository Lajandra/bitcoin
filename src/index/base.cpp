...
bool BaseIndex::Init()
{
    ...
    auto start_sync = [&](const interfaces::BlockInfo& block) {
        ...
        // before m_synced to ensure that CustomInit is always called before
        // CustomAppend. As soon as m_synced is true, CustomAppend calls may
        // start to be made from the notification thread.
