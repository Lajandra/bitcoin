...
BOOST_FIXTURE_TEST_CASE(coinstatsindex_unclean_shutdown, TestChain100Setup)
{
    ...
    const CChainParams& params = Params();
    {
        ...
        // Send block connected notification, then stop the index with sending a
        // chainstate flushed notification. Prior to #24138, this would cause
        // the index to be corrupted and fail to reload.
        Connect block, and stop index without flushing
