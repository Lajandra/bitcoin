...
||||||| parent of 5700aaad306 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
...
>>>>>>> 5700aaad306 (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
        };
    }
