...
||||||| parent of c5efc79787b (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
    return {ChainstateLoadStatus::SUCCESS, {}};
=======
    return {};
>>>>>>> c5efc79787b (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
}
