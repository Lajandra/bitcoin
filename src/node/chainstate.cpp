...
||||||| parent of cb648f870dc (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
...
util::Result<void, ChainstateLoadError> LoadChainstate(ChainstateManager& chainman, const CacheSizes& cache_sizes,
                                                       const ChainstateLoadOptions& options)
>>>>>>> cb648f870dc (refactor: Use util::Result class in LoadChainstate and VerifyLoadedChainstate)
{
