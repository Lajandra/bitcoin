...
const char* OptionsModel::SettingName(OptionID option)
{
    ...
    case ThreadsScriptVerif: return "par";
    case SpendZeroConfChange: return "spendzeroconfchange";
    case ExternalSignerPath: return "signer";
    case MapPortUPnP: return "upnp";
    case MapPortNatpmp: return "natpmp";
    case Listen: return "listen";
    case Server: return "server";
    case PruneSize: return "prune";
    case Prune: return "prune";
    case ProxyIP: return "proxy";
    case ProxyPort: return "proxy";
    case ProxyUse: return "proxy";
    case ProxyIPTor: return "onion";
    case ProxyPortTor: return "onion";
    case ProxyUseTor: return "onion";
